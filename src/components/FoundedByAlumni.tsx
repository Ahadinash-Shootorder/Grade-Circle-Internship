...
export const FoundedByAlumni = () => {
  return (
    <section className="w-full">
      ...
      {/* Desktop Version */}
       <div className="hidden lg:block w-full relative -top-20">
        <div className="max-w-[998px] mx-auto">
          {/* Yellow Header */}
          <div className="bg-[#f8b402] rounded-2xl py-16 px-6 shadow-md">
          ...
          {/* Logos Container */}
          <div className="bg-white rounded-xl relative -top-16 shadow-lg py-8 px-12 flex items-center justify-center gap-16 max-w-[500px] mx-auto">
            <img
