  ...
  const deliverables = [
    {
      ...
      icon: "https://c.animaapp.com/mjmwrwbp4K97wU/img/pg-3-icon-1.png",
    },
    {
      text: "8 -10 hours of teamwork and assignments",
      icon: "https://c.animaapp.com/mjmwrwbp4K97wU/img/pg-3-icon-2.png",
    },
    {
      text: "Simulated project-based internship",
      icon: "https://c.animaapp.com/mjmwrwbp4K97wU/img/pg-3-icon-3.png",
    },
    {
      text: "Project evaluation & comprehensive Skills Report",
      icon: "https://c.animaapp.com/mjmwrwbp4K97wU/img/pg-3-icon-4.png",
    },
    {
      text: "Internship Certificate signed by the mentor",
      icon: "https://c.animaapp.com/mjmwrwbp4K97wU/img/pg-3-icon-5.png",
    },
    {
      text: "Merit-based Letter of Recommendation",
      icon: "https://c.animaapp.com/mjmwrwbp4K97wU/img/pg-3-icon-6.png",
    },
  ];
    ...
    <section className="w-full mb-5">
      ...
      <div className="block md:hidden w-full px-3 py-5 bg-[#f7f7f7]">
        ...
        <div className="flex justify-center">
          <a
            href="#contact-form"
            className="bg-[#ef7f1a] text-white font-bold text-xl py-4 px-12 rounded-full hover:bg-[#d66f15] active:bg-[#c06312] transition-all duration-200 shadow-md hover:shadow-lg inline-flex items-center justify-center"
          >
            Apply Now
          </a>
        </div>
      ...
      <div className="hidden md:block lg:hidden w-full px-8 py-16 bg-[#f7f7f7]">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center">
            <a
              href="#contact-form"
              className="bg-[#ef7f1a] text-white font-bold text-2xl py-6 px-16 rounded-full hover:bg-[#d66f15] active:bg-[#c06312] transition-all duration-200 shadow-md hover:shadow-lg inline-flex items-center justify-center"
            >
              Apply Now
            </a>
          </div>
      ...
      <div className="hidden lg:block w-full py-16 bg-white">
        <div className="max-w-[1340px] mx-auto px-[50px]">
          <div className="mb-12">
            <h2 className="font-['Inter',Helvetica] font-bold text-[#0e416f] text-[64px] leading-tight">
              Program
            </h2>
            <div className="[-webkit-text-stroke:1.7px_#ef7f1a] font-['Inter',Helvetica] font-bold text-transparent text-8xl">
              Deliverables
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6 mb-8">
            {deliverables.slice(0, 4).map((item, index) => (
              <div
                key={index}
                className="relative bg-[#133b93] rounded-[19px] pt-12 pb-8 px-6 overflow-hidden"
              >
                {/* ICON */}
                <img
                  src={item.icon}
                  alt="Icon"
                  className="w-[140px] h-[140px] absolute -left-10 top-1/2 -translate-y-1/2"
                />

                {/* TEXT */}
                <p className="relative z-10 ml-20 font-['Inter'] font-bold text-white text-xl text-left leading-tight">
                  {item.text}
                </p>
              </div>
            ))}
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-6 max-w-[680px] mx-auto mb-12">
          ...
          <div className="flex justify-center">
            <a
              href="#contact-form"
              className="bg-[#ef7f1a] w-[345px] h-[86px] rounded-[50px] flex items-center justify-center hover:bg-[#d66f15] active:bg-[#c06312] transition-all duration-200"
            >
